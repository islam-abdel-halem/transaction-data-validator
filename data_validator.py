...
def main() -> None:
    """Run a short demonstration of validation and cleaning behavior."""
    raw_transactions = [
        "ID-1234, 150.50, US, 2023-10-01",
        "ID-1235, 200, EU, 2023-10-02",
        "ID-1236, invalid_amount, APAC, 2023-10-03",
        "ID-1237, 99.99, ME",
        "ID-1238, 80.25, CA, 2023-10-05",
    ]

    cleaned_transactions = clean_and_structure(raw_transactions)
    total_sales = calculate_total_sales(cleaned_transactions)
    transaction_ids = [extract_transaction_id(item) for item in cleaned_transactions]
